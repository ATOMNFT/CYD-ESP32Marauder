...
PROGMEM const char text0_0[] = "HACKING room for HardwareSerial...";
PROGMEM const char text0_1[] = "Started Serial";
PROGMEM const char text0_2[] = "Scanned RAM";
...
PROGMEM const char text0_7[] = "LED System Started";
...
PROGMEM const char text1_6[] = "CM Box 0.13.9 ";
PROGMEM const char text1_7[] = "WiFi ";
PROGMEM const char text1_8[] = "Bad USB ";
PROGMEM const char text1_9[] = "CM-Box ";
...
PROGMEM const char text1_17[] = "Box Info ";
...
PROGMEM const char text1_56[] = "Select Ap";
...
PROGMEM const char text4_20[] = "Firmware: C-Marauder";      //From 20 to 35 add spaces so : is in line like it is now
...
PROGMEM const char text4_41[] = " Bluetooth Sniffing ";
