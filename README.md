...
<p align="center">
  ...
  <br> <b>This fork features a few great fixes and customzations. <br> I have tweaked a section of two files (EvilPortal.cpp & SDInterface) to allow the portals <br> used in EP to be stored in a folder on the sd card instead of just being stored in the root folder.</b>
  <br> 
