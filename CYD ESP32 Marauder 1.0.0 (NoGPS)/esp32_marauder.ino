...
void setup()
{
  ...
  */
  ...
  #ifdef HAS_SCREEN
    display_obj.tft.drawCentreString("Custom Marauder", TFT_WIDTH/2, TFT_HEIGHT * 0.33, 1);
    display_obj.tft.drawCentreString("JustCallMeKoKo", TFT_WIDTH/2, TFT_HEIGHT * 0.5, 1);
    display_obj.tft.drawCentreString("Customized by ATOMNFT", TFT_WIDTH/2, TFT_HEIGHT * 0.55, 1);
